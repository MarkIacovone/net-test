                     ...
                     <td>
                        <table bgcolor="#4184F3" width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width:332px;max-width:600px;border:1px solid #E0E0E0;border-bottom:0;border-top-left-radius:3px;border-top-right-radius:3px;">
                           <tbody>
                              ...
                              <tr>
                                 <td width="32px"></td>
                                 <td style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:24px;color:#FFFFFF;line-height:1.25;">NET La Plata <a href="http://netlaplata.com.ar/camaras" target="_blank" style="text-decoration:none;color:#FFFFFF;"> - Cámaras de seguridad</a></td>
                                 <td width="32px"></td>
                              </tr>
                              <tr>
                  ...
                  <tr>
                     <td>
                        <table style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:10px;color:#666666;line-height:18px;padding-bottom:10px;">
                           <tbody>
                              <tr>
                                 <td>Te hemos enviado este correo electrónico desde el formulario de contacto de la web de <a href="http://netlaplata.com.ar/camaras" target="_blank" style="text-decoration:none;color:#4285F4;">NET La Plata </a></td>
                              </tr>
                              <tr>
                                 <td>
                                    <div style="direction:ltr;text-align:left;">© 2014 NET La Plata - Todos los derechos reservados - Powered by NET La Plata</div>
                                 </td>
                              </tr>
                           </tbody>
                        </table>
